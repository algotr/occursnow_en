...
urlpatterns = patterns('',
                       ...
                       url(r'^user/(?P<username>\w{0,30})/$', 'home.views.user_page', name='user_page'),
                       ...
                       url(r'^follow/(?P<username>\w{0,30})/$', 'home.views.follow', name='follow'),
                       url(r'^unfollow/(?P<username>\w{0,30})/$', 'home.views.unfollow', name='unfollow'),
